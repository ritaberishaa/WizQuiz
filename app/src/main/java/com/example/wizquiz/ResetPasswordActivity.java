        ...
        btnSavePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pass1.isEmpty() || pass2.isEmpty()) {
                    Toast.makeText(ResetPasswordActivity.this, "Plotësoni fushat!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                finish(); // Mbyll këtë aktivitet (kthehet te WelcomeActivity/LoginActivity)
            }
        });
    }
}
